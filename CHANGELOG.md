...
- `neuralfetch`: `Xu2024Alljoined` and `Xu2025Alljoined` download the NEMAR BIDS releases nm000133 v1.0.4 and nm000134 v1.0.3 (stimuli included) with nemar-py; images come from each event's `stim_file`.
