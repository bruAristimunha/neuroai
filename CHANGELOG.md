...
- `neuralfetch`: new `Nemar` download backend (nemar-py; `tag=` pins the version, `scope=` picks raw/stimuli/…); `Xu2024Alljoined` and `Xu2025Alljoined` use it for the NEMAR BIDS releases nm000133 v1.0.4 and nm000134 v1.0.3, with images from each event's `stim_file` (#279).
