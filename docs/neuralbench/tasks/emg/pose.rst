...
uses that metadata directly, returning standard SI values (volts and radians)
without study-specific numerical rescaling.
...
preprocessing, and per-user aggregation.
